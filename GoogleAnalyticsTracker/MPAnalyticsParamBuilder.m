...
{
    NSAssert(eventCategory && eventAction, @"eventCategory and eventAction arguments should be != nil. Use [NSNull null] to remove one of the parameters from request");
	
	if (eventLabel == nil) {
		eventLabel = (id)[NSNull null];
	}
	if (eventValue == nil) {
		eventValue = (id)[NSNull null];
	}
